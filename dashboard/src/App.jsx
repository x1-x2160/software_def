    ...
    <div className="shell" role="main">
        ...
        <div className="dash" id="dash-view">
          ...
          <div className="tbl-wrap">
            <table>
              ...
              <tbody>
                {results.modules.slice(0, 20).map((m, i) => { //changed module slice from 10 to 20.
          ...
          <div className="reasons-box">
            ...
            {results.modules.slice(0, 20).map((m, i) => { //changed the mdule slice from 10 to 20 here.
      ...
      <div className="dev-credits">
        ...
        <div className="dev-names">
          ...
          <span className="dot">•</span>
          <span>OLOWA MOSOPE OLUWAPELUMI</span>
        </div>
      </div>
